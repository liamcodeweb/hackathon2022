      ...
      <div className="px-4 sm:px-6 md:px-8">
        ...
        <div className="relative max-w-5xl mx-auto pt-20 sm:pt-24 lg:pt-32">
          <h1 className="text-slate-900 font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-center dark:text-white">
            Kho tài liệu và ôn luyện tiếng anh.
          </h1>
          <p className="mt-6 text-lg text-slate-600 text-center max-w-3xl mx-auto dark:text-slate-400">
            30 chủ điểm ngữ pháp ôn luyện THPT, 40.000+ bài tập{' '}
            <span className="font-medium text-sky-500 dark:text-sky-400">
              có đáp án và lời giải chi tiết
            </span>
            , 600+ đề thi thử các trường chuyên & đề thi chính thức
          </p>
...
export default function Home() {
  return (
    <>
      <Head>
        <meta key="twitter:title" name="twitter:title" content="GAMMA - Ôn luyện tiếng anh THPT" />
        <meta key="og:title" property="og:title" content="GAMMA - Ôn luyện tiếng anh THPT" />
        <title>GAMMA - Ôn luyện tiếng anh THPT</title>
      </Head>
        ...
        <section className="text-center px-8">
          ...
          <figure>
            ...
            <figcaption className="mt-6 flex items-center justify-center space-x-4 text-left">
              ...
              />
              <div>
                <div className="text-slate-900 font-semibold dark:text-white">Vinh Nguyễn</div>
