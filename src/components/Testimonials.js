...
let testimonials = [
  [
    {
      content: 'Tiếng anh của mình đã cải thiện rất nhiều sau khi biết đến GAMMA.',
    ...
    {
      content:
        'Không thể tin là mình có thể tiếp cận được những nội dung chất lượng như thế này một cách miễn phí.',
      url: 'https://twitter.com/rauchg/status/1225611926320738304',
      author: {
        name: 'Chém gió thành bão',
        role: 'Học viện bôn ba',
